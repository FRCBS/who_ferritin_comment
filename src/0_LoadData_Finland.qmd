...
#| code-fold: true
data_3 <- data %>% mutate(within4years = ifelse(as.numeric(Donatiedatum-RefDonDate)<=(365.25*4),1,0)) %>% filter(within4years==1)%>%select(-within4years)
...
| Donor age        | Numeric | Age at donation                                               | Years                               | We use this for creation of the premenopausal variable                                            |
